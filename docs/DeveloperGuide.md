...
3.  User requests to add a specific stall to the list by keying stall name and location
4.  FoodNotes adds the stall to list
...
**Use case: Review a stall**

**MSS**

1.  User requests to list stalls
2.  FoodNotes shows a list of stalls
3.  User requests to review a stall by providing stall number, star rating and description
4.  FoodNotes add the review to the stall
...
* 3b. The description is not specified

    * 3b1. FoodNotes shows an error message.
...
1.  User requests to list stalls
2.  FoodNotes shows a list of stalls
3.  User requests to add a menu item to the stall
4.  FoodNotes add a menu item to the stall
...
**Use case: Review a menu item from a stall**
...
2.  FoodNotes shows a list of stalls
3.  User requests to view a stall
4.  User requests to a review a menu item from the stall
...
* 4b. The description is not specified

    * 4b1. FoodNotes shows an error message.
